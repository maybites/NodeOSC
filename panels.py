...
class OSC_PT_Settings(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(bpy.context.scene.nodeosc_envars, 'nodeosc_udp_in', text="Listen on ")
        layout.prop(bpy.context.scene.nodeosc_envars, 'nodeosc_udp_out', text="Destination address")
        col2 = layout.column(align=True)
        row2 = col2.row(align=True)
        row2.prop(bpy.context.scene.nodeosc_envars, 'nodeosc_port_in', text="Input port")
        row2.prop(bpy.context.scene.nodeosc_envars, 'nodeosc_port_out', text="Outport port")
