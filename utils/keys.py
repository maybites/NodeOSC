...
class NodeOSCMsgValues(bpy.types.PropertyGroup):
        ...
        filter_enable: bpy.props.BoolProperty(name = "Filter", default = False, description = "enable filtering of incomming messages based on the incomming arguments")
        filter_eval: bpy.props.StringProperty(name="Evaluate", default="args[0] == 0", description = "the filter condition to be evaluated. The result of the evaluated condition must be a 'true' or 'false'. Available keywords: array 'args' for all incomming arguments")
