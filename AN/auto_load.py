...
def register():
    try:
        ...
        print("Unable to find any animation node classes")
...
def get_all_submodules(package_dir, directory):
    return list(iter_submodules(directory, package_dir.name))
...
def iter_submodule_names(path, root="AN."):
    for _, module_name, is_package in pkgutil.iter_modules([str(path)]):
        if is_package:
            ...
            print("module_name: ", root + module_name)
